							...
							<div class="cart-items clear" v-for="item,index in order.goodsData">
								<div class="prod-info clear">
									<div class="items-thumb">
										<a href="javascript:;" target="_blank"><img :src="item.aliimage+'?x-oss-process=image/resize,w_80/quality,Q_100/format,webp'"></a>
									</div>
									<div class="items-params clear">
										<div class="name vh-center">
											<a href="javascript:;" target="_blank" :title="item.pname">{{item.pname}}</a>
										</div>
...
.order-list-cart .cart-title .operation .operation-list{
  width: 85px;
  padding-right: 27px;
  text-align: right;
}
